...
public class ResponseMessage {
	...
	public final static String PASSWORD_CHANGE_MESSAGE="Password Successfully Changed";

	public final static String UPDATE_RESPONSE_MESSAGE="User Successfully Updated";
	...
	public final static String CAR_AVAILABILITY_MESSAGE="Car availability checked";
